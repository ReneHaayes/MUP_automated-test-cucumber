...
import {scenario1} from '../../../pageobjects/zakelijkeVerzekeringen/ondernemersScan/ondernemersScanElements';
...
When(/^I enter my details for personal advice$/, async () => {
  await genericMethods.waitForElementIsVisibleWithXpath( "//*[@class='appointment__title']", 20000);
