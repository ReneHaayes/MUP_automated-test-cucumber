...
import {ZzpFlexMethods} from "../../../pageobjects/zakelijkeVerzekeringen/bedrijfsActiviteitenVerzekeringen/zzpFlexMethods";
import {GenericMethods} from "../../../pageobjects/generic/genericMethods";
import {PersonaData} from "../../../pageobjects/persona/persona";
import {ZzpFlexElements} from "../../../pageobjects/zakelijkeVerzekeringen/bedrijfsActiviteitenVerzekeringen/zzpFlexElements";
...
When(/^I enter step two page of zzpFlex for persona (.*)$/, async (persona: string) => {
  ...
  await genericMethods.typeText(zzpFlexElements.zzpYourDataBirthdate, personaData.getPersonaBirthDate(persona));
