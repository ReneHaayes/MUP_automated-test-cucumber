...
bijnaVerzekerdGeenVoorlopigeDekkingTextElement: string = 'unive-almost-insured-text-cross-sell > div > p:nth-child(2) > strong';
...
bijnaVerzekerdVoorlopigeDekkingZorgText: string = 'gaat deze in per';
bijnaVerzekerdVoorlopigeDekkingDRVText: string = 'heeft u een voorlopige dekking vanaf';
...
bedankpaginaIngangsdatumGelijkDRVAnnuleringText: string = 'Uw zorgverzekering en doorlopende reis- en annuleringsverzekering gaan in op';
