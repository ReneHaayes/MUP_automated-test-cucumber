export class AlleVerzekeringenElements {
  ...
  camperVerzekeringBerekenUwPremieButtonClickElement: string = '[class="productsMain_productNavigation"] [title="Bereken uw premie"][href="/camperverzekering/premieberekenen-en-afsluiten"]';
  caravanVerzekeringBerekenUwPremieButtonClickElement: string = '[class="productsMain_productNavigation"] [title="Bereken nu uw premie"][href="/caravanverzekering/premieberekenen-en-afsluiten"]';
