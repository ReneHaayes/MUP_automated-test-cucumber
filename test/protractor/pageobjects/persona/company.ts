...
export class CompanyData {
  ...
  peej_advies_en_control: Company = new Company('Peej Advies en Control', '9731PB', '77948378', legalEnum.EENMANSZAAK, '141', genericEnum.EMPTY, 'Zakelijk advies', '0651537139', 'Patrick@peejadviesencontrol.nl');
