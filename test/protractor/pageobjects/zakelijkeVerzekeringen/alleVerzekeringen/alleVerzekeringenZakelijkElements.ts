export class AlleVerzekeringenZakelijkElements {
  ...
  //TITLE
  bedrijfsAutoVerzekeringH1TitleText: string = 'Bedrijfsauto\n' + 'verzekering';
  bedrijfsSchadeVerzekeringH1TitleText: string = 'Bedrijfsschade\n' + 'verzekering';
  beroepsAansprakelijkheidsVerzekeringH1TitleText: string = 'Beroepsaansprake-\n' + 'lijkheidsverzekering';
  bestuurdersAansprakelijkheidsVerzekeringH1TitleText: string = 'Bestuurders-\n' + 'aansprakelijkheids\n' + 'verzekering';
  constructieAllRiskVerzekeringH1TitleText: string = 'Constructie Allrisk\n' + 'verzekering\n' + '(CAR-verzekering)';
  eigenVervoerVerzekeringH1TitleText: string = 'Eigen vervoer\n' + 'verzekering';
  gebouwenVerzekeringH1TitleText: string = 'Gebouwen\n' + 'verzekering';
  handelaarsKentekenVerzekeringH1TitleText: string = 'Handelaars-\n' + 'kenteken\n' + 'verzekering';
  milieSchadeVerzekeringH1TitleText: string = 'Milieuschade\n' + 'verzekering (MSV)';
  zakelijkAutoverzekeringH1TitleText: string = 'Zakelijke auto\n' + 'verzekering';
  zakelijkMotorVerzekeringH1TitleText: string = 'Zakelijke motor\n' + 'verzekering';
  zakelijkRechtsbijstandVerzekeringH1TitleText: string = 'Zakelijke\n' + 'rechtsbijstand\n' + 'verzekering';
  vrachtAutoH1TitleText: string = 'Vrachtwagenverzekering';
  werkmateriaalVerzekeringH1TitleText: string = 'Werkmaterieel\n' + 'verzekering';
