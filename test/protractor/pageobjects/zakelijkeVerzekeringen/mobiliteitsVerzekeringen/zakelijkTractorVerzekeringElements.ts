export class ZakelijkTractorVerzekeringElements {
  ...
  // LICENSEPLATE
  licensePlateInputElement: string = '#_Form_IF37106_28618';
  licenceplateTractorYesElement: string = '#_Form_IF37106_47317_true';
  licenceplateTractorNoElement: string = '[data-label-id="LA_IF37106_47317"] [class="radioList"] > label:nth-child(2)';
