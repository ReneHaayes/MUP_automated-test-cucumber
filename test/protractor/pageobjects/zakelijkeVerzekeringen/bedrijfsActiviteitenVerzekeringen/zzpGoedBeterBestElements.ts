export class ZzpGoedBeterBestElements {
  ...
  transferDate = '[data-di-id="di-id-8b1b8b5-cd37d62f"]';
  reportingCode = '[data-di-id="di-id-54d98ce1-4ff9d6de"]';
  ownerNoElement = 'div.additional-information__fieldset-container.additional-information__fieldset-container--company-car.ng-star-inserted > ui-fieldset > fieldset > div.additional-information__group-question > ui-radio-group > div > ui-radio-button:nth-child(2) > label';
  ownerYesElement = 'div.additional-information__fieldset-container.additional-information__fieldset-container--company-car.ng-star-inserted > ui-fieldset > fieldset > div.additional-information__group-question > ui-radio-group > div > ui-radio-button:nth-child(3) > label';

  // COMPANY LIABILITY INSURANCE QUESTIONS
  fireHazardousWorkNoElement = 'div.additional-information__fieldset-container.additional-information__fieldset-container--liability > ui-fieldset > fieldset > div:nth-child(2) > ui-radio-group > div > ui-radio-button:nth-child(2) > label';
  fireHazardousWorkYesElement = 'div.additional-information__fieldset-container.additional-information__fieldset-container--liability > ui-fieldset > fieldset > div:nth-child(2) > ui-radio-group > div > ui-radio-button:nth-child(3) > label';


  workMainlyAbroadNoElement = 'div.additional-information__fieldset-container.additional-information__fieldset-container--liability > ui-fieldset > fieldset > div:nth-child(3) > ui-radio-group > div > ui-radio-button:nth-child(2)';
  workMainlyAbroadYesElement = 'div.additional-information__fieldset-container.additional-information__fieldset-container--liability.ng-star-inserted > ui-fieldset > fieldset > div:nth-child(3) > ui-radio-group > div > ui-radio-button:nth-child(3) > label';
  countriesBeLuxDuElement = 'div.additional-information__fieldset-container.additional-information__fieldset-container--liability.ng-star-inserted > ui-fieldset > fieldset > zp-checkbox-group > div > div:nth-child(1) > ui-checkbox';
  countriesOtherInEuropeElement = 'div.additional-information__fieldset-container.additional-information__fieldset-container--liability.ng-star-inserted > ui-fieldset > fieldset > zp-checkbox-group > div > div:nth-child(2) > ui-checkbox';
  ...
  companyDataEmailAddressInputElement = 'ui-fieldset:nth-child(1) > fieldset > div.personal-information__fields-input > div:nth-child(3) > ui-input > div > label > input';
  companyDataEmailAddressConfirmInputElement = 'ui-fieldset:nth-child(1) > fieldset > div.personal-information__fields-input > div:nth-child(4) > ui-input > div > label > input';
  // USER INFO
  contactDataInitialsInputElement = 'ui-fieldset.personal-information__fields > fieldset > div.personal-information__fields-input > div:nth-child(1) > ui-input > div > label > input';
  contactDataPrefixInputElement = 'ui-fieldset.personal-information__fields > fieldset > div.personal-information__fields-input > div:nth-child(2) > ui-input > div > label > input';
  contactDataLastNameInputElement = 'ui-fieldset.personal-information__fields > fieldset > div.personal-information__fields-input > div:nth-child(3) > ui-input > div > label > input';
  contactDataBirthdayInputElement = 'ui-fieldset.personal-information__fields > fieldset > div.personal-information__fields-input > div:nth-child(4) > ui-input > div > label > input';
  contactDataGenderMaleInputElement = 'ui-fieldset.personal-information__fields > fieldset > div.personal-information__fields-info > div > ui-radio-group > div > ui-radio-button:nth-child(2)';
  contactDataGenderFemaleInputElement = 'ui-fieldset.personal-information__fields > fieldset > div.personal-information__fields-info > div > ui-radio-group > div > ui-radio-button:nth-child(3)';
  contactDataAccountNumberElement = 'ui-fieldset:nth-child(3) > fieldset > div.personal-information__fields-input > div > ui-input > div > label > input';

  // ALMOST INSURED PAGE
  // Insurance History
  insuranceHistoryNoElement = 'ui-fieldset:nth-child(2) > fieldset > ui-radio-group > div > ui-radio-button:nth-child(1) > label';
  insuranceHistoryYesElement = 'ui-fieldset:nth-child(2) > fieldset > ui-radio-group > div > ui-radio-button:nth-child(2) > label';
  explanationInsuranceHistoryElement = 'ui-fieldset:nth-child(2) > fieldset > div.almost-insured__input-wrapper.ng-star-inserted > ui-textarea > label > textarea';
 // Criminal History
  criminalHistoryNoElement = 'ui-fieldset:nth-child(3) > fieldset > ui-radio-group > div > ui-radio-button:nth-child(1) > label';
  criminalHistoryYesElement = 'ui-fieldset:nth-child(3) > fieldset > ui-radio-group > div > ui-radio-button:nth-child(2) > label';
  // Damage history
  damageHistoryNoElement = 'ui-fieldset:nth-child(4) > fieldset > ui-radio-group > div > ui-radio-button:nth-child(1) > label';
  damageHistoryYesElement = 'ui-fieldset:nth-child(4) > fieldset > ui-radio-group > div > ui-radio-button:nth-child(2) > label';
