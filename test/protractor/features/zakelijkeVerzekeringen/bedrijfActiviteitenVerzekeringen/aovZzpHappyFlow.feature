...
Feature: Happy flow for 'aovZzp'
  ...
  Scenario Outline: Filling in the quickest happy flow to get to the "Thank you" page.
    ...
    And I enter step two page of aovZzp for <persona> with
      | notWorkForFourteenDays | no |
      | consultedDoctor        | no |
      | medicines              | no |
      | disabilityBenefit      | no |
    And I enter step three page of aovZzp with
      | lifeInsurance                | yes       |
    ...
    And I enter step four page of aovZzp for persona <persona>
